...
def train():
    ...
    train_images = sorted(glob("tumor-segmentation/datasets/original_augmented_50k/imgs/*.png"))
    train_masks = sorted(glob("tumor-segmentation/datasets/original_augmented_50k/labels/*.png"))
